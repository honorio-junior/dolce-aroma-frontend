<template>
    <h2 class="text-2xl font-medium px-2 text-center mt-2 text-white">Cafeteria e Restaurante</h2>
    <main class="px-2">
...
import { getCardapioCafeteria } from '../services/indexService';
...
onMounted(async () => {
    cardapio.value = await getCardapioCafeteria();
});
</script>
