<template>
    <!-- footer -->
    <footer class="bg-success mt-5 pt-2">
        <div class="flex gap-5 justify-center items-center mb-2">
            <!-- whatsapp -->
            ...
            ></span>
            <!-- instagram -->
            <span @click="instagram()" class="rounded-full p-2 bg-black/40 cursor-pointer text-white flex items-center gap-2"
                ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                >
                    ...
                    /></svg
            >@{{ contatos.instagram }}</span>
        </div>
        <p class="text-center text-xs bg-zinc-200 text-zinc-700 font-normal">
                <span class="text-center text-black/80">© JardimEuropaMall -</span>
            Desenvolvido por
            <a
                target="_blank"
