<template>
    <h2 class="text-2xl font-medium px-2 text-center mt-2 text-white">Comércio</h2>
    <main class="px-2">
...
import { getCardapioComercio } from '../services/indexService';
...
onMounted(async () => {
    cardapio.value = await getCardapioComercio();
});
</script>
